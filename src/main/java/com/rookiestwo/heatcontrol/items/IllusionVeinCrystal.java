...
public class IllusionVeinCrystal extends TrinketItem {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(
        ...
        modifiers.put(
                HeatAttributeManager.MAX_TEMPERATURE, new EntityAttributeModifier(uuid,"heatcontrol:max_temperature",1000,EntityAttributeModifier.Operation.ADDITION));
        modifiers.put(
                HeatAttributeManager.MIN_TEMPERATURE, new EntityAttributeModifier(uuid,"heatcontrol:min_temperature",-70,EntityAttributeModifier.Operation.ADDITION));
        return modifiers;
    }
}
